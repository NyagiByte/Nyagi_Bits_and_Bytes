...
public class ModItems {
    ...
    public static final RegistryObject<Item>
            Tier_Zero_Strawberry = ITEMS.register("tier_zero_strawberry", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Tier 0 Golden Strawberry added 2/21/23 - Nyagi
    public static final RegistryObject<Item>
            Golden_Tier_Zero_Strawberry = ITEMS.register("golden_tier_zero_strawberry", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Tier 1 Strawberry added 2/21/23 - Nyagi
    public static final RegistryObject<Item>
            Tier_One_Strawberry = ITEMS.register("tier_one_strawberry", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Tier 1 Golden Strawberry added 2/21/23 - Nyagi
    public static final RegistryObject<Item>
            Golden_Tier_One_Strawberry = ITEMS.register("golden_tier_one_strawberry", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Tier 2 Strawberry added 5/16/23 - Nyagi
    public static final RegistryObject<Item>
            Tier_Two_Strawberry = ITEMS.register("tier_two_strawberry", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Tier 2 Golden Strawberry added 5/16/23 - Nyagi
    public static final RegistryObject<Item>
            Golden_Tier_Two_Strawberry = ITEMS.register("golden_tier_two_strawberry", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));

    //Livisite Alloy added 7/11/23 - Nyagi
    public static final RegistryObject<Item>
            Livisite_Alloy = ITEMS.register("livisite_alloy", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Livisite Slate added 7/11/23 - Nyagi
    public static final RegistryObject<Item>
            Livisite_Slate = ITEMS.register("livisite_slate", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Crude Abrasive added 7/11/23 - Nyagi
    public static final RegistryObject<Item>
            Crude_Abrasive = ITEMS.register("crude_abrasive", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Pile of Cogs added 7/11/23 - Nyagi
    public static final RegistryObject<Item>
            Pile_of_Cogs = ITEMS.register("pile_of_cogs", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Pile of Crude Mechanical Parts added 7/11/23 - Nyagi
    public static final RegistryObject<Item>
            Pile_of_Crude_Mechanical_Parts = ITEMS.register("pile_of_crude_mechanical_parts", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Soil Sample added 7/25/23 - Nyagi
    public static final RegistryObject<Item>
            Soil_Sample = ITEMS.register("soil_sample", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Sturdy Box added 7/25/23 - Nyagi
    public static final RegistryObject<Item>
            Sturdy_Box = ITEMS.register("sturdy_box", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Sealed Pouch added 7/25/23 - Nyagi
    public static final RegistryObject<Item>
            Sealed_Pouch = ITEMS.register("sealed_pouch", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Salt Water added 7/25/23 - Nyagi
    public static final RegistryObject<Item>
            Salt_Water = ITEMS.register("bucket_of_salt_water", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Torn Wool Ball added 7/25/23 - Nyagi
    public static final RegistryObject<Item>
            Torn_Wool_Ball = ITEMS.register("torn_wool_ball", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Etched Redstone Plate added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Etched_Redstone_Plate = ITEMS.register("etched_redstone_plate", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Crude Silicon Boule added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Crude_Silicon_Boule = ITEMS.register("crude_silicon_boule", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Diamond Shard added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Diamond_Shard = ITEMS.register("diamond_shard", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Logic Dud added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Logic_Dud = ITEMS.register("logic_dud", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    ...
    public static final RegistryObject<Item>
            Calculation_Dud = ITEMS.register("calculation_dud", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    ...
    public static final RegistryObject<Item>
            Engineering_Dud = ITEMS.register("engineering_dud", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Incomplete Calculation Dud added 2/21/24 - Nyagi
    public static final RegistryObject<Item>
    ...
    public static final RegistryObject<Item>
            Bottle_Of_Anthocyanin = ITEMS.register("bottle_of_anthocyanin", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Bottle of Malic & Citric Acid added 8/27/23 - Nyagi
    public static final RegistryObject<Item>
            Bottle_Of_Malic_And_Citric_Acid = ITEMS.register("bottle_of_malic_and_citric_acid", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Chemistry Rack added 8/27/23 - Nyagi
    public static final RegistryObject<Item>
            Chemistry_Rack = ITEMS.register("chemistry_rack", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Basic Composite Material added 8/27/23 - Nyagi
    public static final RegistryObject<Item>
            Basic_Composite_Material = ITEMS.register("basic_composite_material", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Basic Composite Plate added 8/27/23 - Nyagi
    public static final RegistryObject<Item>
            Basic_Composite_Plate = ITEMS.register("basic_composite_plate", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Compacted Soil added 3/17/24 - Nyagi
    public static final RegistryObject<Item>
            Compacted_Soil = ITEMS.register("compacted_soil", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Tough Bag added 3/17/24 - Nyagi
    public static final RegistryObject<Item>
            Tough_Bag = ITEMS.register("tough_bag", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Empty Petri Dish added 3/20/24 - Nyagi
    public static final RegistryObject<Item>
            Petri_Dish = ITEMS.register("petri_dish_empty", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Agar-Gel added 3/25/24 - Nyagi
    public static final RegistryObject<Item>
            Agar_Gel = ITEMS.register("agar_gel", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Agar-Flakes added 3/25/24 - Nyagi
    public static final RegistryObject<Item>
            Agar_Flakes = ITEMS.register("agar_flakes", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Agar-Powder added 3/25/24 - Nyagi
    public static final RegistryObject<Item>
            Agar_Powder = ITEMS.register("agar_powder", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Agar-Agar added 3/20/24 - Nyagi
    public static final RegistryObject<Item>
            Agar_Agar = ITEMS.register("agar_agar", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Agar-Agar Petri Dish added 3/20/24 - Nyagi
    public static final RegistryObject<Item>
            Petri_Dish_Agar_Agar = ITEMS.register("petri_dish_agar_agar", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Sponged Steel added 3/25/24 - Nyagi
    public static final RegistryObject<Item>
            Sponged_Steel = ITEMS.register("sponged_steel", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Sodium Polyacrylate added 3/26/24 - Nyagi
    public static final RegistryObject<Item>
            Sodium_Polyacrylate = ITEMS.register("sodium_polyacrylate", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Endoflame Mush added 3/26/24 - Nyagi
    public static final RegistryObject<Item>
            Endoflame_Mush = ITEMS.register("endoflame_mush", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Hydroangeas Mush added 7/20/24 - Nyagi
    public static final RegistryObject<Item>
            Hydroangeas_Mush = ITEMS.register("hydroangeas_mush", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Gourmaryllis Mush added 7/20/24 - Nyagi
    public static final RegistryObject<Item>
            Gourmaryllis_Mush = ITEMS.register("gourmaryllis_mush", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Thermalily Mush added 7/20/24 - Nyagi
    public static final RegistryObject<Item>
            Thermalily_Mush = ITEMS.register("thermalily_mush", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Entropinnyum Mush added 7/20/24 - Nyagi
    public static final RegistryObject<Item>
            Entropinnyum_Mush = ITEMS.register("entropinnyum_mush", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Munchdew Mush added 7/20/24 - Nyagi
    public static final RegistryObject<Item>
            Munchdew_Mush = ITEMS.register("munchdew_mush", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Narslimmus Mush added 7/20/24 - Nyagi
    public static final RegistryObject<Item>
            Narslimmus_Mush = ITEMS.register("narslimmus_mush", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Rosa Arcana Mush added 7/20/24 - Nyagi
    public static final RegistryObject<Item>
            Rosa_Arcana_Mush = ITEMS.register("rosa_arcana_mush", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Manasteel Lattice added 3/26/24 - Nyagi
    public static final RegistryObject<Item>
            Manasteel_Lattice = ITEMS.register("manasteel_lattice", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Rune Binder added 3/26/24 - Nyagi
    public static final RegistryObject<Item>
            Rune_Binder = ITEMS.register("rune_binder", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Rubberized Cable added 4/10/24 - Nyagi
    public static final RegistryObject<Item>
            Rubberized_Cable = ITEMS.register("rubberized_cable", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Ceramic added 4/10/24 - Nyagi
    public static final RegistryObject<Item>
            Ceramic = ITEMS.register("ceramic", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Activated Charcoal added 4/10/24 - Nyagi
    public static final RegistryObject<Item>
            Activated_Charcoal = ITEMS.register("activated_charcoal", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Sturdy Tray added 4/10/24 - Nyagi
    public static final RegistryObject<Item>
            Sturdy_Tray = ITEMS.register("sturdy_tray", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Beaker added 4/10/24 - Nyagi
    public static final RegistryObject<Item>
            Beaker = ITEMS.register("beaker", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Round Bottom Flask added 4/10/24 - Nyagi
    public static final RegistryObject<Item>
            Round_Bottom_Flask = ITEMS.register("round_bottom_flask", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Distillation Column added 4/10/24 - Nyagi
    public static final RegistryObject<Item>
            Distillation_Column = ITEMS.register("distillation_column", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Inlet added 4/10/24 - Nyagi
    public static final RegistryObject<Item>
            Inlet = ITEMS.register("inlet", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Burette added 4/10/24 - Nyagi
    public static final RegistryObject<Item>
            Burette = ITEMS.register("burette", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Sterilized Quartz Glass added 4/10/24 - Nyagi
    public static final RegistryObject<Item>
            Sterilized_Quartz_Glass = ITEMS.register("sterilized_quartz_glass", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //pH Strip added 4/10/24 - Nyagi
    public static final RegistryObject<Item>
            PH_Strip = ITEMS.register("ph_strip", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Bottle of Vinegar added 4/10/24 - Nyagi
    public static final RegistryObject<Item>
            Bottle_Of_Vinegar = ITEMS.register("bottle_of_vinegar", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Low Grade Coke added 4/21/24 - Nyagi
    public static final RegistryObject<Item>
            Low_Grade_Coke = ITEMS.register("low_grade_coke", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Industrial Grade Coke added 4/21/24 - Nyagi
    public static final RegistryObject<Item>
            Industrial_Grade_Coke = ITEMS.register("industrial_grade_coke", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Wrought Ball Bearing added 4/21/24 - Nyagi
    public static final RegistryObject<Item>
            Wrought_Ball_Bearing = ITEMS.register("wrought_ball_bearing", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Wrought Tiny Spring added 4/21/24 - Nyagi
    public static final RegistryObject<Item>
            Wrought_Tiny_Spring = ITEMS.register("wrought_tiny_spring", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Wrought Iron Rod added 4/21/24 - Nyagi
    public static final RegistryObject<Item>
            Wrought_Iron_Rod = ITEMS.register("wrought_iron_rod", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Mixed Seeds added 4/21/24 - Nyagi
    public static final RegistryObject<Item>
            Mixed_Seeds = ITEMS.register("mixed_seeds", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Hard Hat added 4/21/24 - Nyagi
    public static final RegistryObject<Item>
            Hard_Hat = ITEMS.register("hard_hat", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Protective Eye-wear added 5/1/24 - Nyagi
    public static final RegistryObject<Item>
            Protective_Eye_Wear = ITEMS.register("protective_eye_wear", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Fire Extinguisher added 5/1/24 - Nyagi
    public static final RegistryObject<Item>
            Fire_Extinguisher = ITEMS.register("fire_extinguisher", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Organic Vapor Respirator added 5/1/24 - Nyagi
    public static final RegistryObject<Item>
            Organic_Vapor_Respirator = ITEMS.register("organic_vapor_respirator", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Hardened Mechanical Bearing added 5/1/24 - Nyagi
    public static final RegistryObject<Item>
            Hardened_Mechanical_Bearing = ITEMS.register("hardened_mechanical_bearing", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Fasteners added 5/1/24 - Nyagi
    public static final RegistryObject<Item>
            Fasteners = ITEMS.register("fasteners", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Synchronous Electric Motor added 5/1/24 - Nyagi
    public static final RegistryObject<Item>
            Synchronous_Electric_Motor = ITEMS.register("synchronous_electric_motor", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Industrial Gear added 5/1/24 - Nyagi
    public static final RegistryObject<Item>
            Industrial_Gear = ITEMS.register("industrial_gear", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Dampener added 5/1/24 - Nyagi
    public static final RegistryObject<Item>
            Dampener = ITEMS.register("dampener", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Reinforced Gearbox added 5/1/24 - Nyagi
    public static final RegistryObject<Item>
            Reinforced_Gearbox = ITEMS.register("reinforced_gearbox", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //V-Belt added 5/1/24 - Nyagi
    public static final RegistryObject<Item>
            V_Belt = ITEMS.register("v_belt", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Solenoid Component added 5/1/24 - Nyagi
    public static final RegistryObject<Item>
            Solenoid_Component = ITEMS.register("solenoid_component", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Flux Mixture added 5/8/24- Nyagi
    public static final RegistryObject<Item>
            Flux_Mixture = ITEMS.register("flux_mixture", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Damascus Steel added 5/13/24- Nyagi
    public static final RegistryObject<Item>
            Steel_Damascus = ITEMS.register("steel_damascus", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //High Carbon Steel - 1080 added 5/13/24- Nyagi
    public static final RegistryObject<Item>
            Steel_High_Carbon_1080 = ITEMS.register("steel_high_carbon_1080", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //High Carbon Steel - 15N20 added 5/13/24- Nyagi
    public static final RegistryObject<Item>
            Steel_High_Carbon_15N20 = ITEMS.register("steel_high_carbon_15n20", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Stainless Steel added 5/13/24- Nyagi
    public static final RegistryObject<Item>
            Steel_Stainless = ITEMS.register("steel_stainless", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Aluminum Trichloride added 5/16/24- Nyagi
    public static final RegistryObject<Item>
            Aluminum_Trichloride = ITEMS.register("aluminum_trichloride", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Toluene added 5/16/24- Nyagi
    public static final RegistryObject<Item>
            Toluene = ITEMS.register("toluene", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Mononitrotoluene added 5/16/24- Nyagi
    public static final RegistryObject<Item>
            Mononitrotoluene = ITEMS.register("mononitrotoluene", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Dinitrotoluene added 5/16/24- Nyagi
    public static final RegistryObject<Item>
            Dinitrotoluene = ITEMS.register("dinitrotoluene", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //2-4-6 Trinitrotoluene added 5/16/24- Nyagi
    public static final RegistryObject<Item>
            Trinitrotoluene = ITEMS.register("trinitrotoluene", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Methyl Chloride added 5/16/24- Nyagi
    public static final RegistryObject<Item>
            Methyl_Chloride = ITEMS.register("methyl_chloride", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Oleum added 5/16/24- Nyagi
    public static final RegistryObject<Item>
            Oleum = ITEMS.register("oleum", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Chromium Trioxide added 5/22/24- Nyagi
    public static final RegistryObject<Item>
            Chromium_Trioxide = ITEMS.register("chromium_trioxide", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Ethylene Oxide added 5/22/24- Nyagi
    public static final RegistryObject<Item>
            Ethylene_Oxide = ITEMS.register("ethylene_oxide", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Benzyl Alcohol added 5/22/24- Nyagi
    public static final RegistryObject<Item>
            Benzyl_Alcohol = ITEMS.register("benzyl_alcohol", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //2-Phenoxyethanol added 5/22/24- Nyagi
    public static final RegistryObject<Item>
            Two_Phenoxyethanol = ITEMS.register("2_phenoxyethanol", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Low Voltage Capacitor added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Low_Voltage_Capacitor = ITEMS.register("low_voltage_capacitor", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Threaded Composite Leather added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Threaded_Composite_Leather = ITEMS.register("threaded_composite_leather", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Industrial Composite Plate added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Industrial_Composite_Plate = ITEMS.register("industrial_composite_plate", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Lead-Acid Cell added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Lead_Acid_Cell = ITEMS.register("lead_acid_cell", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Heavy Plating added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Heavy_Plating = ITEMS.register("heavy_plating", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Soldering Iron added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Soldering_Iron = ITEMS.register("soldering_iron", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Low Temperature Solder added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Low_Temperature_Solder = ITEMS.register("low_temperature_solder", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Ceramic Encased Copper added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Ceramic_Encased_Copper = ITEMS.register("ceramic_encased_copper", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Hydraulic Hammer added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Hydraulic_Hammer = ITEMS.register("hydraulic_hammer", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Tempered Glass added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Tempered_Glass = ITEMS.register("tempered_glass", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Annealed Glass added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Annealed_Glass = ITEMS.register("annealed_glass", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Tungsten Wire added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Tungsten_Wire = ITEMS.register("tungsten_wire", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Woven Cloth added 6/5/24- Nyagi
    public static final RegistryObject<Item>
            Woven_Cloth = ITEMS.register("woven_cloth", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Solder Wire added 6/8/24- Nyagi
    public static final RegistryObject<Item>
            Solder_Wire = ITEMS.register("solder_wire", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Fluorophlogopite added 6/28/24- Nyagi
    public static final RegistryObject<Item>
            Fluorophlogopite = ITEMS.register("fluorophlogopite", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Synthetic Mica added 6/28/24- Nyagi
    public static final RegistryObject<Item>
            Synthetic_Mica = ITEMS.register("synthetic_mica", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //TPV Cell added 6/28/24- Nyagi
    public static final RegistryObject<Item>
            TPV_Cell = ITEMS.register("tpv_cell", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Polycrystalline Silicon Carbide added 6/28/24- Nyagi
    public static final RegistryObject<Item>
            Polycrystalline_Silicon_Carbide = ITEMS.register("polycrystalline_silicon_carbide", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Zinc-Gallium-Antimony Alloy added 6/28/24- Nyagi
    public static final RegistryObject<Item>
            Zinc_Gallium_Antimony_Alloy = ITEMS.register("zinc_gallium_antimony_alloy", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Ash  added 7/15/24- Nyagi
    public static final RegistryObject<Item>
            Ash = ITEMS.register("ash", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Potash  added 7/15/24- Nyagi
    public static final RegistryObject<Item>
            Potash = ITEMS.register("potash", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Wood Ash  added 7/15/24- Nyagi
    public static final RegistryObject<Item>
            Wood_Ash = ITEMS.register("wood_ash", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Metamorphic Alloy  added 7/15/24- Nyagi
    public static final RegistryObject<Item>
            Metamorphic_Alloy = ITEMS.register("metamorphic_alloy", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Ore Extraction Plate  added 7/15/24- Nyagi
    public static final RegistryObject<Item>
            Ore_Extraction_Plate = ITEMS.register("ore_extraction_plate", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Chromatic Compound  added 8/3/24- Barza
    public static final RegistryObject<Item>
            Chromatic_Compound = ITEMS.register("chromatic_compound", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Refined Radiance  added 8/3/24- Barza
    public static final RegistryObject<Item>
            Refined_Radiance = ITEMS.register("refined_radiance", () -> new LevitatingItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Shadow Steel  added 8/3/24- Barza
    public static final RegistryObject<Item>
            Shadow_Steel = ITEMS.register("shadow_steel", () -> new LevitatingItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));

    //Ae2 Assembly added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Ae2_Assembly = ITEMS.register("ae2_assembly", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Crystal_Harmonizer added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Crystal_Harmonizer = ITEMS.register("crystal_harmonizer", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Processor_Stack added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Processor_Stack = ITEMS.register("processor_stack", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Energized_Frame added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Energized_Frame = ITEMS.register("energized_frame", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Energized_Wires added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Energized_Wires = ITEMS.register("energized_wires", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Skystone Shielding added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Skystone_Shielding = ITEMS.register("skystone_shielding", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Matter Converters added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Matter_Converters = ITEMS.register("matter_converters", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Decorative Paneling added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Decorative_Paneling = ITEMS.register("decorative_paneling", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //MicroTools added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Micro_Tools = ITEMS.register("micro_tools", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    ...
    public static final RegistryObject<Item>
            Botania_Assembly = ITEMS.register("botania_assembly", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Semi-organic Substrate added 3/17/24- Nyagi
    public static final RegistryObject<Item>
            Semi_Organic_Substrate = ITEMS.register("semi_organic_substrate", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Soil Conditioner added 3/17/24- Nyagi
    public static final RegistryObject<Item>
            Soil_Conditioner = ITEMS.register("soil_conditioner", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Living Frame added 3/17/24- Nyagi
    public static final RegistryObject<Item>
            Living_Frame = ITEMS.register("living_frame", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Terrarium added 3/17/24- Nyagi
    public static final RegistryObject<Item>
            Terrarium = ITEMS.register("terrarium", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Organic Pseudo Logic added 3/17/24- Nyagi
    public static final RegistryObject<Item>
            Organic_Pseudo_Logic = ITEMS.register("organic_pseudo_logic", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Sealant added 3/17/24- Nyagi
    public static final RegistryObject<Item>
            Sealant = ITEMS.register("sealant", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Magnetic Hematite added 3/17/24- Nyagi
    public static final RegistryObject<Item>
            Magnetic_Hematite = ITEMS.register("magnetic_hematite", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Mystic Fertilizer added 3/17/24- Nyagi
    public static final RegistryObject<Item>
            Mystic_Fertilizer = ITEMS.register("mystic_fertilizer", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));

    //Alchemistry Assembly added 4/6/24- Nyagi
    public static final RegistryObject<Item>
            Alchemistry_Assembly = ITEMS.register("alchemistry_assembly", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Electrolytic Core added 4/6/24- Nyagi
    public static final RegistryObject<Item>
            Electrolytic_Core = ITEMS.register("electrolytic_core", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Desiccation Powder added 4/6/24- Nyagi
    public static final RegistryObject<Item>
            Desiccation_Powder = ITEMS.register("desiccation_powder", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Chemical Grade Glassware added 4/6/24- Nyagi
    public static final RegistryObject<Item>
            Chemical_Grade_Glassware = ITEMS.register("chemical_grade_glassware", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Fume Fan added 4/6/24- Nyagi
    public static final RegistryObject<Item>
            Fume_Fan = ITEMS.register("fume_fan", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Chemically Inert Wood added 4/6/24- Nyagi
    public static final RegistryObject<Item>
            Chemically_Inert_Wood = ITEMS.register("chemically_inert_wood", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //pH Strips added 4/6/24- Nyagi
    public static final RegistryObject<Item>
            PH_Strips = ITEMS.register("ph_strips", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Chromatography Kit added 4/6/24- Nyagi
    public static final RegistryObject<Item>
            Chromatography_Kit = ITEMS.register("chromatography_kit", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Bunsen Burner added 4/6/24- Nyagi
    public static final RegistryObject<Item>
            Bunsen_Burner = ITEMS.register("bunsen_burner", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));

    //Immersive Assembly added 4/25/24- Nyagi
    public static final RegistryObject<Item>
            Immersive_Assembly = ITEMS.register("immersive_assembly", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //High Temperature Heat Exchanger added 4/25/24- Nyagi
    public static final RegistryObject<Item>
            High_Temperature_Heat_Exchanger = ITEMS.register("high_temperature_heat_exchanger", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Duct Tape added 4/25/24- Nyagi
    public static final RegistryObject<Item>
            Duct_Tape = ITEMS.register("duct_tape", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //WD40 added 4/25/24- Nyagi
    public static final RegistryObject<Item>
            WD40 = ITEMS.register("wd_40", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //79" x 28" TRIPLE-BAY 4s SERIES TOOLBOX added 4/25/24- Nyagi
    public static final RegistryObject<Item>
            Triple_Bay_4s_Series_Toolbox = ITEMS.register("triple_bay_4s_series_toolbox", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Acetylene Tank added 4/25/24- Nyagi
    public static final RegistryObject<Item>
            Acetylene_tank = ITEMS.register("acetylene_tank", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //OSHA Approved Gear added 4/25/24- Nyagi
    public static final RegistryObject<Item>
            OSHA_Approved_Gear = ITEMS.register("osha_approved_gear", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Crate Of Industrial Components added 4/25/24- Nyagi
    public static final RegistryObject<Item>
            Crate_Of_Industrial_Components = ITEMS.register("crate_of_industrial_components", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //High Strength Concrete added 4/25/24- Nyagi
    public static final RegistryObject<Item>
            High_Strength_Concrete = ITEMS.register("high_strength_concrete", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));

    //Blank Rune added 3/8/24 - Nyagi
    public static final RegistryObject<Item>
            Rune_Blank = ITEMS.register("rune_blank", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Optical Rune added 3/8/24 - Nyagi
    public static final RegistryObject<Item>
            Rune_Optical = ITEMS.register("rune_optical", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Velocity Rune added 3/8/24 - Nyagi
    public static final RegistryObject<Item>
            Rune_Velocity = ITEMS.register("rune_velocity", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Inertia Rune added 3/8/24 - Nyagi
    public static final RegistryObject<Item>
            Rune_Inertia = ITEMS.register("rune_inertia", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Thermodynamic Rune added 3/8/24 - Nyagi
    public static final RegistryObject<Item>
            Rune_Thermodynamic = ITEMS.register("rune_thermodynamic", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Magnetic Rune added 3/8/24 - Nyagi
    public static final RegistryObject<Item>
            Rune_Magnetic = ITEMS.register("rune_magnetic", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Catalytic Rune added 3/8/24 - Nyagi
    public static final RegistryObject<Item>
            Rune_Catalytic = ITEMS.register("rune_catalytic", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    //Computational Rune added 3/8/24 - Nyagi
    public static final RegistryObject<Item>
            Rune_Computational = ITEMS.register("rune_computational", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
        /*
    ...
    public static final RegistryObject<Item>
            Crude_Compression_Test = ITEMS.register("crude_compression_test", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    public static final RegistryObject<Item>
            Used_Crude_Compression_Test = ITEMS.register("used_crude_compression_test", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));    //Used/Crude Compression Test added 7/18/23 - Nyagi
    //Used/Crude Statics Test added 7/18/23 - Nyagi
    public static final RegistryObject<Item>
            Crude_Statics_Test = ITEMS.register("crude_statics_test", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    public static final RegistryObject<Item>
            Used_Crude_Statics_Test = ITEMS.register("used_crude_statics_test", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));    //Used/Crude Compression Test added 7/18/23 - Nyagi
    //Used/Crude Entropy Test added 7/18/23 - Nyagi
    public static final RegistryObject<Item>
            Crude_Entropy_Test = ITEMS.register("crude_entropy_test", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    public static final RegistryObject<Item>
            Used_Crude_Entropy_Test = ITEMS.register("used_crude_entropy_test", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));    //Used/Crude Compression Test added 7/18/23 - Nyagi
    //Used/Crude Acidics Test added 8/27/23 - Nyagi
    public static final RegistryObject<Item>
            Crude_Acidics_Test = ITEMS.register("crude_acidics_test", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    public static final RegistryObject<Item>
            Used_Crude_Acidics_Test = ITEMS.register("used_crude_acidics_test", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));    //Used/Crude Compression Test added 7/18/23 - Nyagi
    //Used/Crude Natural Arcana Test added 8/27/23 - Nyagi
    public static final RegistryObject<Item>
            Crude_Natural_Arcana_Test = ITEMS.register("crude_natural_arcana_test", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    public static final RegistryObject<Item>
            Used_Crude_Natural_Arcana_Test = ITEMS.register("used_crude_natural_arcana_test", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));    //Used/Crude Compression Test added 7/18/23 - Nyagi
    //Used/Crude Material Properties Test added 8/27/23 - Nyagi
    public static final RegistryObject<Item>
            Crude_Material_Properties_Test = ITEMS.register("crude_material_properties_test", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    public static final RegistryObject<Item>
            Used_Crude_Material_Properties_Test = ITEMS.register("used_crude_material_properties_test", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    /*
       SCIENCE DATA STORAGE
     */
    //added 8/10/23 - Nyagi
    public static final RegistryObject<Item>
            Lab_Notebook = ITEMS.register("lab_notebook", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    public static final RegistryObject<Item>
            Lab_Notebook_With_Crude_Compression_Data = ITEMS.register("lab_notebook_with_crude_compression_data", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    public static final RegistryObject<Item>
            Lab_Notebook_With_Crude_Statics_Data = ITEMS.register("lab_notebook_with_crude_statics_data", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    public static final RegistryObject<Item>
            Lab_Notebook_With_Crude_Entropy_Data = ITEMS.register("lab_notebook_with_crude_entropy_data", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    //added 8/27/23 - Nyagi
    public static final RegistryObject<Item>
            Lab_Notebook_With_Crude_Acidics_Data = ITEMS.register("lab_notebook_with_crude_acidics_data", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    public static final RegistryObject<Item>
            Lab_Notebook_With_Crude_Natural_Arcana_Data = ITEMS.register("lab_notebook_with_crude_natural_arcana_data", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    public static final RegistryObject<Item>
            Lab_Notebook_With_Crude_Material_Properties_Data = ITEMS.register("lab_notebook_with_crude_material_properties_data", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCIENCE)));
    public static final RegistryObject<Item>
            Pen = ITEMS.register("pen", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    public static final RegistryObject<Item>
            Pen_Assembly = ITEMS.register("pen_assembly", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    public static final RegistryObject<Item>
            Ball_Bearing = ITEMS.register("ball_bearing", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    public static final RegistryObject<Item>
            Thin_Casing = ITEMS.register("thin_casing", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    public static final RegistryObject<Item>
            Tiny_Spring = ITEMS.register("tiny_spring", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    public static final RegistryObject<Item>
            Ink_Cartridge = ITEMS.register("ink_cartridge", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    public static final RegistryObject<Item>
            Ink = ITEMS.register("ink", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_ITEMS)));
    ...
    public static final RegistryObject<Item>
            Blank_Blueprint = ITEMS.register("blank_blueprint", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCHEMATICS)));
    public static final RegistryObject<Item>
            Ae2_Schematic = ITEMS.register("ae2_schematic", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCHEMATICS)));
    public static final RegistryObject<Item>
            Botania_Schematic = ITEMS.register("botania_schematic", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCHEMATICS)));
    public static final RegistryObject<Item>
            Immersive_Engineering_Schematic = ITEMS.register("immersive_engineering_schematic", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCHEMATICS)));
    public static final RegistryObject<Item>
            Alchemistry_Schematic = ITEMS.register("alchemistry_schematic", () -> new CustomTooltipItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_SCHEMATICS)));
    ...
    //Iron-related added 9/29/23 - Nyagi
        //Limonite
            public static final RegistryObject<Item>
                    Raw_Limonite = ITEMS.register("raw_limonite", () -> new CustomOreItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_MINERALS)));
        //Hematite
            public static final RegistryObject<Item>
                    Raw_Hematite = ITEMS.register("raw_hematite", () -> new CustomOreItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_MINERALS)));
        //Magnetite
            public static final RegistryObject<Item>
                    Raw_Magnetite = ITEMS.register("raw_magnetite", () -> new CustomOreItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_MINERALS)));
        //Pyrite
            public static final RegistryObject<Item>
                    Raw_Pyrite = ITEMS.register("raw_pyrite", () -> new CustomOreItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_MINERALS)));
        //Siderite
            public static final RegistryObject<Item>
                    Raw_Siderite = ITEMS.register("raw_siderite", () -> new CustomOreItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_MINERALS)));
        //Banded Iron
            public static final RegistryObject<Item>
                    Raw_Banded_Iron = ITEMS.register("raw_banded_iron", () -> new CustomOreItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_MINERALS)));
        //Bog Iron
            public static final RegistryObject<Item>
                    Raw_Bog_Iron = ITEMS.register("raw_bog_iron", () -> new CustomOreItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_MINERALS)));
        //Meteoric
            public static final RegistryObject<Item>
                    Raw_Meteoric_Iron = ITEMS.register("raw_meteoric_iron", () -> new CustomOreItem(new Item.Properties().tab(ModCreativeModeTab.NYAGIBITS_BYTES_MINERALS)));
