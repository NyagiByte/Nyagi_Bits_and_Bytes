...
public class ModMiningTiers {
    ...
    static {
        MANASTEEL = TierSortingRegistry.registerTier(new ForgeTier(5,
                ...
                () -> Ingredient.EMPTY), new ResourceLocation(NyagiBits_Bytes.MOD_ID, "manasteel"), List.of(Tiers.NETHERITE), List.of());
        ELEMENTIUM = TierSortingRegistry.registerTier(new ForgeTier(6,
                ...
                () -> Ingredient.EMPTY), new ResourceLocation(NyagiBits_Bytes.MOD_ID, "elementium"), List.of(MANASTEEL), List.of());
        TERRASTEEL = TierSortingRegistry.registerTier(new ForgeTier(7,
                ...
                () -> Ingredient.EMPTY), new ResourceLocation(NyagiBits_Bytes.MOD_ID, "terrasteel"), List.of(ELEMENTIUM), List.of());
        ALFSTEEL = TierSortingRegistry.registerTier(new ForgeTier(8,
                ...
                () -> Ingredient.EMPTY), new ResourceLocation(NyagiBits_Bytes.MOD_ID, "alfsteel"), List.of(TERRASTEEL), List.of());
        FLAKE = TierSortingRegistry.registerTier(new ForgeTier(9,
                ...
                () -> Ingredient.EMPTY), new ResourceLocation(NyagiBits_Bytes.MOD_ID, "flake"), List.of(ALFSTEEL), List.of());
    }
}
