...
43.2
====
 - 43.2.14 Fix erroneous getLevel call when firing SpecialSpawn (#9520)
 - 43.2.13 [1.19.2] Fix the rest of the spawn event calls (#9482)
 - 43.2.12 Loosen access for BucketItem's canBlockContainFluid (#9429)
 - 43.2.11 Fix event result being ignored (#9484)
           Co-authored-by: Brennan Ward <3682588+Shadows-of-Fire@users.noreply.github.com>
 - 43.2.10 Fix incorrect SpecialSpawn fire location (#9480)
           Co-authored-by: Brennan Ward <3682588+Shadows-of-Fire@users.noreply.github.com>
 - 43.2.9  [1.19.2] Fix forge grindstone hooks allowing stacks of non-stackable items (#9466)
 - 43.2.8  Fix JSON model root transforms (#9411)
 - 43.2.7  Fix StemBlock not checking canSustainPlant for the correct block
           It now checks for Melons/Pumpkins instead of the stem itself.
 - 43.2.6  Fix of inconsistent vaporization in BucketItem & FluidType (#9340)
 - 43.2.5  Backport `ClientChatReceivedEvent.System` for 1.19.2. Fixes #9352 (#9355)
